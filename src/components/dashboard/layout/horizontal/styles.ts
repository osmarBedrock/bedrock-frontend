...
export const navColorStyles = {
  dark: {
    blend_in: {
      ...
      '--GoogleButton-background': 'var(--mui-palette-neutral-200)',
      '--GoogleButton-border': 'var(--mui-palette-neutral-300)',
      '--GoogleButton-color': 'var(--mui-palette-neutral-900)',
      '--GoogleButton-hover-background': 'var(--mui-palette-neutral-100)',
      '--GoogleButton-hover-border': 'var(--mui-palette-neutral-200)',
      '--GoogleButton-icon-filter': 'none',
    },
    discrete: {
  ...
  light: {
    blend_in: {
      ...
      '--Workspaces-expand-color': 'var(--mui-palette-neutral-400)',
      '--GoogleButton-background': 'var(--mui-palette-neutral-800)',
      '--GoogleButton-border': 'var(--mui-palette-neutral-900)',
      '--GoogleButton-color': 'var(--NavItem-active-color)',
      '--GoogleButton-hover-background': 'var(--mui-palette-neutral-950)',
      '--GoogleButton-hover-border': 'var(--mui-palette-neutral-800)',
      '--GoogleButton-icon-filter': 'brightness(0) invert(1)',
    },
    discrete: {
